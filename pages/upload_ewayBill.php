...
?>
        ...
        if (isset($_POST['upload'])) {
            ...
            $filename = $eway_bill['name'];
            $filerrror = $eway_bill['error'];
            $filetmp = $eway_bill['tmp_name'];
            ...
            if (in_array($filecheck, $fileextstored)) {
                ...
                $q = "update invoice_details set eway_bill=' $destinationfile'
             where id=$id  ";

                $query = mysqli_query($connection, $q);
                if ($query) {
                    echo "<script> alert('Eway bill Uploaded successfully.....');
                ...
                echo "<script>
                 alert('Kindly Upload 'png', 'pdf', 'jpeg'!!');
                 window.location.href='update_invoice.php'</script>";
            }
        }
        ?>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <form class="form-horizontal" enctype='multipart/form-data' action='#' method='post'>
                                    ...
                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-end control-label col-form-label">Eway Bill</label>
                                        <div class="col-sm-9">
