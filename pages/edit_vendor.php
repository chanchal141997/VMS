...
if (isset($_POST['edit'])) {
   ...
   $vendor_no=$_POST['vendor_no'];
    ...
    $q = " update vendor set vendor_no='$vendor_no', c_name='$c_name',c_address='$c_address',c_person='$c_person',number='$number',
    email='$email',pan='$pan',gst='$gst',msme='$msme'  where vendor_id=$id  ";
    $query = mysqli_query($connection, $q);
     $admin_q= "update admin set vendor_no='$vendor_no',email='$email' where vendor_id=$id";
     $admin_query = mysqli_query($connection, $admin_q);
    if ($query) {
        echo '<script> alert("Vendor Details Updated successfully.....")</script>';
        header("Location:./vendors_details.php");
    } else {
                                    ...
                                    <form class="form-horizontal" method="POST" action="#">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group row">
                                                <label for="fname" class="col-sm-3 text-end control-label col-form-label">Vendor No </label>
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" id="fname" name="vendor_no" value="<?php echo $row['vendor_no']; ?>"  />
                                                </div>
                                            </div>
                                            <div class="form-group row">
