...
?>
        ...
        if (isset($_POST['upload'])) {
            ...
            $filename = $proof_trans['name'];
            $filerrror = $proof_trans['error'];
            $filetmp = $proof_trans['tmp_name'];
            ...
            if (in_array($filecheck, $fileextstored)) {
                ...
                $q = "update invoice_details set proof_trans=' $destinationfile'
             where id=$id  ";

                $query = mysqli_query($connection, $q);
                if ($query) {
                    echo "<script> alert('Proof of Transportation Uploaded successfully.....');
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <form class="form-horizontal" enctype='multipart/form-data' action='#' method='post'>
                                    ...
                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-end control-label col-form-label">Proof of Transportation</label>
                                        <div class="col-sm-9">
